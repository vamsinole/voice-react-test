                    ...
                    <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                        ...
                        <ul className="menu-inner py-1">
                            <li className="menu-item">
                               ...
                               <Link className="nav-link" to="/userscontrols">User and Controls</Link>
                            </a></li>
                            <li className="menu-item"><a className="menu-link">
                                 <Link className="nav-link" to="#">Organization</Link>
                            </a></li>
                            <li className="menu-item"><a className="menu-link">
                                <Link className="nav-link" to="#">Fields</Link>
                            </a></li>
                            <li className="menu-item"><a className="menu-link">
                                <Link className="nav-link" to="#">Stages</Link>
                            </a></li>
                            <li className="menu-item"><a className="menu-link">
                                <Link className="nav-link" to="#">Forms</Link>
                            </a></li>
