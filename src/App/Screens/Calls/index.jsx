...
const Calls = () => {
  ...
  const handleCellClick = async (value) => {
    ...
    try {
      ...
      let sortdata = response.data.data.sort((a, b) => a.id.localeCompare(b.id));
                                        ...
                                        <ul class="list-unstyled chat-contact-list listpointer" id="chat-list">
                                          ...
                                          {dataFromApi ? dataFromApi.map((value, key) => {
                                            ...
                                            return (
                                              ...
                                              <li class="chat-contact-list-item " className={activeItem === value ? 'active' : ''}
                                                onClick={() => handleItemClick(value)} >
                                                <a class="d-flex align-items-center">
                                                  <div class="chat-contact-info flex-grow-1 ms-2">

                                                    <div key={key} onClick={() => handleCellClick(value)}  >
                                                      <h6 class="chat-contact-name text-truncate m-0 text-lg-start " >{value.to}
                                        ...
                                        <div class="chat-history-header border-bottom">
                                          <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex overflow-hidden align-items-center">
                                              ...
                                              <div class="chat-contact-info flex-grow-1 ms-2">
                                                <h6 class="m-0">{messagename}</h6>
                                                <small class="user-status text-muted">{messagetime}</small>
                                              </div>
                                            </div>
                                              ...
                                              <div class="d-flex overflow-hidden">
                                                <div class="chat-message-wrapper text-white flex-grow-1">
                                                  ...
                                                  {textMessge ? textMessge.map((value, key) => {
                                                    ...
                                                    return (
                                                      <div key={key} onClick={() => handleCellClick(value)} className={key % 2 === 0 ? 'chat-message-text my-2' : 'left-content'}>
