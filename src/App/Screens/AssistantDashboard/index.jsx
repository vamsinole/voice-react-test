                                    ...
                                    <div className="form-control">
                                      <div className="d-flex">
                                        <div className=" ">
                                          ...
                                          <p>
                                            Toggle to record calls for playback
                                            and easy reveiw in the logs.
                                          </p>
                                        </div>
                                      ...
                                      <div className="col-md-5 mt-3">
                                        ...
                                        <p className="lh-sm">
                                          <small>
                                            ...
                                            limit, the campanign will no longer
                                            be active and you will be notified.
                                          </small>
                                        </p>
                                      </div>
                              ...
                              <div className="d-flex justify-content-between mt-3">
                                ...
                                <div className="mt-2">
                                  <button className="btn btn-outline-secondary">
                                    <i class="las la-folder-open la-lg"></i> Use
                                    a Template
                                  </button>
                                </div>
                              </div>
