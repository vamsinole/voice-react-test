...
// sorting table start
const tableData = [
  { name: 'John', model:"Lorem Ipsum is1", instruc: 'adfdf Lorem Ipsum is simply dummy text of the printing', type: 'Dialogdlow4', action:'' },
  { name: 'Alice', model:"Lorem Ipsum is2", instruc: 'dfdfa Lorem Ipsum is simply dummy text of the printing', type: 'Dialogdlow2', action:'' },
  { name: 'Bob', model:"Lorem Ipsum is3", instruc: 'iuychn Lorem Ipsum is simply dummy text of the printing', type: 'Dialogdlow3', action:'' },
  { name: 'Rob', model:"Lorem Ipsum is4", instruc: 'uiivdn Lorem Ipsum is simply dummy text of the printing', type: 'Dialogdlow1', action:'' },
   ...
   <div className='border-top border-bottom'>
      ...
      <thead>
        <tr>
          ...
          INSTRUCTIONS {sortConfig.key === 'instruc' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
          </th>
          ...
          <tr key={row.id}>
            ...
            <td style={{ width: '70px' }}>
              <div className="d-flex acation-btns">
                <button className='acation-btns'><i className="las la-play la-lg"></i></button>
                <button className='acation-btns'><i className="las la-trash-alt la-lg"></i></button>
              </div>
            </td>
          </tr>
        ))}
